...
const BenefitCard = ({ icon, title, text }) => (
  <div className="bg-white rounded-2xl p-6 hover:shadow-xl transition-all duration-300 border border-[#eec4a2]/30 hover:border-[#eec4a2]/70 transform hover:-translate-y-1 group">
    <div className="flex justify-center items-center w-16 h-16 rounded-full bg-[#eec4a2]/10 text-3xl mb-5 mx-auto group-hover:bg-[#eec4a2]/20 transition-all duration-300">
      {icon}
    </div>
    <h3 className="text-xl font-semibold text-[#6b4226] mb-3 text-center">{title}</h3>
    <p className="text-[#8b5a2b]/80 leading-relaxed text-center">{text}</p>
  </div>
);
...
const FeatureItem = ({ children }) => (
  <li className="flex items-center gap-2 text-[#6b4226]/90">
    <span className="text-[#eec4a2]">✦</span>
    {children}
  </li>
);
...
const CamphorBenefits = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#faf6f2] to-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Hero Section */}
        <div className="text-center mb-16">
          <h2 className="text-[#efb98c] font-light uppercase tracking-widest mb-3">Pure & Natural</h2>
          <h1 className="text-4xl md:text-5xl font-bold text-[#6b4226] mb-6">
            Premium Camphor Solutions
          </h1>
          <p className="text-[#8b5a2b]/80 text-lg max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-center mb-16">
          <div className="h-px bg-[#eec4a2]/30 w-1/3"></div>
          <div className="px-4 text-[#eec4a2]">✦</div>
          <div className="h-px bg-[#eec4a2]/30 w-1/3"></div>
        </div>
        
        {/* Additional Information Section */}
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg border border-[#eec4a2]/20 flex flex-col md:flex-row gap-12">
          <div className="md:w-1/2">
            <h3 className="text-2xl font-semibold text-[#6b4226] mb-6">Why Choose Our Camphor?</h3>
          ...
          <div className="md:w-1/2">
            <h3 className="text-2xl font-semibold text-[#6b4226] mb-6">How To Use</h3>
            <ul className="space-y-3">
