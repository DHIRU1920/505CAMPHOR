  ...
  const posts = [
    {
      ...
      excerpt: 'In the heart of Sangli, 505 Camphor has emerged as a trusted name...',
      date: 'Sep 20, 2023',
      author: 'Admin',
      image: img1,
    },
    ...
    },
    {
      ...
      excerpt: '505 Camphor is a white, crystalline substance derived from the wood...',
      date: 'Sep 23, 2023',
      author: 'Admin',
      image: img5,
    },
    {
      ...
      excerpt: 'As environmental awareness continues to grow, so does the demand...',
      date: 'Sep 25, 2023',
      author: 'Admin',
      image: img4,
    },
    ...
    },
    {
      ...
      excerpt: '505 Camphor, a natural chemical substance with a distinctive fragrance...', 
      date: 'Sep 28, 2023',
      author: 'Admin',
      image: img5,
    },
        ...
        {posts.map((post) => (
          <div key={post.id} className="bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <Link to={`/blog/${post.id}`} className="text-blue-500 hover:underline mt-4 inline-block">
                Read More
              </Link>
            </div>
          </div>
