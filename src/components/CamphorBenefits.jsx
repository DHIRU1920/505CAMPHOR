...
const BenefitCard = ({ icon, title, text }) => (
  <div className="bg-white rounded-2xl p-4 md:p-6 hover:shadow-xl transition-all duration-300 border border-[#eec3a2]/30 hover:border-[#eec3a2]/70 transform hover:-translate-y-1 group">
    ...
    <h3 className="text-lg md:text-xl font-semibold text-[#8b5a2b] mb-2 md:mb-3 text-center">
      {title}
    </h3>
    <p className="text-sm md:text-base text-[#8b5a2b]/80 leading-relaxed text-center">
      {text}
    </p>
  </div>
);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 md:mb-16">
          ...
          <p className="text-sm md:text-lg text-[#ea580c]/80 max-w-2xl mx-auto">
            Experience the ancient wisdom and natural benefits of our
            premium-grade camphor products
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-6 md:p-12 shadow-lg border border-[#000]/20 flex flex-col md:flex-row gap-8 md:gap-12">
          <div className="md:w-1/2">
            <h3 className="text-xl md:text-2xl font-semibold text-[#8b5a2b] mb-4 md:mb-6">
              Why Choose Our Camphor?
            </h3>
          ...
          <div className="md:w-1/2">
            ...
            <ul className="space-y-2 md:space-y-3">
              <FeatureItem>
                Place in living spaces for natural purification
              </FeatureItem>
              <FeatureItem>
                Add to bathwater for therapeutic benefits
              </FeatureItem>
              <FeatureItem>
                Use with a diffuser for aromatic wellness
              </FeatureItem>
              <FeatureItem>Incorporate into meditation practices</FeatureItem>
              <FeatureItem>
                Store with clothing for natural protection
              </FeatureItem>
            </ul>
          </div>
        </div>
